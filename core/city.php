...
@media (max-width: 481px)  {.block-left {
            ...
            .block-right {
             ...
             .popular-left{width:100%}

.popular-right{width:100%}

.row{width:100%}.m-top73 {margin-top: 73px;font-size: 20px;}
    ...
    <body onLoad="doOnLoad();">
        ...
        <div class="wrapper">
            ...
            <?php include 'header-without-form1.php'; ?>
            ...
            <div class="content">
                ...
                <div class="block-left">
                    ...
                    <div class="bread-crumbs">
                        ...
                        <span class="bread-name"><a href="http://www.topmovingreviews.com/index.php">Home</a> <span class="arrow">></span> <a href="http://www.topmovingreviews.com/moving-company.php">Movers </a><span class="arrow">></span> </span><span class="current"> <a href="http://www.topmovingreviews.com/moving-companies/<?php echo ucfirst($cityname)."-".strtoupper($stateshrtname)."-".$zipcode; ?>/"><?php echo ucwords($cityname); ?> Movers</a></span>
...
<?php } else { ?> <img src="https://www.topmovingreviews.com/mmr_images/city_min_images/Denver_CO.jpg" alt="<?php echo str_replace(" ","-",ucfirst($cityname))." ".strtoupper($stateshrtname); ?> Movers Moving Companies"><?php }  ?>
                        ...
                        Moving Reviews for  Top Rated   <?php echo ucwords($cityname).", ".strtoupper($stateshrtname); ?> Movers 
                    ...
                    <div class="sortedclass">
                        ...
                        <div style="text-align:right"><form  name="frm_filter" action='http://www.topmovingreviews.com/moving-companies/<?php echo $cityname."-".$stateshrtname."-".$zipcode; ?>/' method='post'>
                            ...
                            </div>	<div class="popular-listing popular-listing-1">

                        <h2 class="popular-listing-title m-top73" style="margin-top:0px !important;" >

                            <?php echo ucwords($cityname); ?> Movers Reviews
...
{	
	...
	if ($page > 1) 
		...
		$pagination.= "<li><a href=\"http://www.topmovingreviews.com/moving-companies/$cityname-$stateshrtname-$prev/\">Prev</a></li>";
	...
	{	
...

		{
			...
			if ($counter == $page)
				...
				$pagination.= "<li><a href=\"http://www.topmovingreviews.com/moving-companies/$cityname-$stateshrtname-$counter/\">$counter</a></li>";					
...

	{
...

		{
			...
			$pagination.= "<li><a href=\"http://www.topmovingreviews.com/moving-companies/$cityname-$stateshrtname-$lpm1/\">$lpm1</a></li>";

			$pagination.= "<li><a href=\"http://www.topmovingreviews.com/moving-companies/$cityname-$stateshrtname-$lastpage/\">$lastpage</a></li>";		
...

		{
			...
			$pagination.= "<li><a href=\"http://www.topmovingreviews.com/moving-companies/$cityname-$stateshrtname-1/\">1</a></li>";

			$pagination.= "<li><a href=\"http://www.topmovingreviews.com/moving-companies/$cityname-$stateshrtname-2/\">2</a></li>";
	...
	if ($page < $counter - 1) 
		...
		$pagination.= "<li><a href=\"http://www.topmovingreviews.com/moving-companies/$cityname-$stateshrtname-$next/\">Next</a></li>";
...
$result = getNearbyMoversByCity($cityname,$stateshrtname,30,10);
...
var_dump($result);
 ...
 ?>
			 ...
			 /*  echo "Srikana". $ip = $_REQUEST['REMOTE_ADDR']; 
				...
				//echo $get_city = 'select * from cities_extended where state_code like "'.$region.'"';

				 $get_city = "SELECT *, ((ACOS(SIN($lat * 3.14 / 180) * SIN(latitude * 3.14 / 180) + COS($lat * 3.14 / 180) * COS(latitude * 3.14 / 180) * COS(($lon - longitude) * 3.14 / 180)) * 180 / 3.14) * 60 * 1.1515) AS distance FROM cities_extended where state_code = '$stateshrtname' and city<>'$cityname' GROUP BY city HAVING distance<='1000' ORDER BY distance ASC";
		  ...
		  <a href="http://www.topmovingreviews.com/moving-companies/<?php echo str_replace(" ","-",$row['city'])."-".$row['state_code']."-".$row['zip']; ?>/" style='text-transform: capitalize;' title="<?php echo str_replace("-", " ", $row['city']);?>">

		  

		<?php echo round($row['distance'],0)."<span style=font-size:11px>mi</span>"."   ". substr(str_replace("-", " ", $row['city']),0,13).","."   ".$row['state_code']; ?></a>
			    ...
			    ?>
							...
							<div class="city-anchr">
                                ...
                                <a href="https://www.topmovingreviews.com/state-city.php?state=<?php echo $state_name; ?>" style='text-transform: capitalize;' title="<?php echo str_replace("-", " ", $row['city']);?>">
...
<button class=accordion>Tips to find the best affordable movers near you</button>

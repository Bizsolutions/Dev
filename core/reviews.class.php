...
class reviews {
	...
	function create_review($company_id,$review,$firstname,$email,$date,$review_subject,$your_review,$move_size,$order_id,$origin_city,$origin_state,$origin_country,$destination_country,$destination_state, $destination_city,$ip,$container,$link) {

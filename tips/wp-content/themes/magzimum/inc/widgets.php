                ...
                <div class="latest-news-text-wrap">
                  ...
                  <?php if ( false == $disable_excerpt ): ?>
                    <div class="latest-news-summary">
                      <p><?php echo esc_html( magzimum_get_the_excerpt( $excerpt_length, $post ) ); ?></p>
              ...
              <div class="col-sm-6">
                ...
                <?php if ( ! empty( $all_posts ) ): ?>
                  ...
                  <?php if ( false == $disable_excerpt_main ): ?>
                    <p><?php echo esc_html( magzimum_get_the_excerpt( $excerpt_length_main, $post ) ); ?></p>
                  <?php endif ?>
                    ...
                    <?php foreach ( $all_posts as $key => $post ): ?>
                      ...
                      <div class="categorized-news-text-wrap">
                        ...
                        <?php if ( false == $disable_excerpt_side ): ?>
                          <p><?php echo esc_html( magzimum_get_the_excerpt( $excerpt_length_side, $post ) ); ?></p>
                        <?php endif ?>

        ...
        ******************************************************************/
            if ( apply_filters( 'igthemes_customizer_more', true ) ) {
                ...
                $wp_customize->add_section( 'upgrade_premium' , array(
                    'title'      		=> __( 'More Options', 'clearsky' ),
                    'panel'             => 'igtheme_options',
                    'priority'   		=> 1,
                ) );
                ...
                $wp_customize->add_control( new IGthemes_More_Control( $wp_customize, 'upgrade_premium', array(
                    'label'    			=> __( 'Looking for more options?', 'clearsky' ),
...
//home_heading
    ...
    $wp_customize->add_control( new IGthemes_Heading( $wp_customize, 'home_heading', array(
         ...
         'label' => __( 'Posts', 'clearsky' ),
         'description' => __( '', 'clearsky' ),
...
//home_posts_per_page
    ...
    $wp_customize->add_control('home_posts_per_page', array(
        'label' => __('', 'clearsky'),
        'description' => __('Change the number of posts showed in the home page.', 'clearsky'),
        'type' => 'number',
        'section' => 'home-settings',
...
//home_portfolio_heading
    ...
    $wp_customize->add_control( new IGthemes_Heading( $wp_customize, 'home_portfolio_heading', array(
         'section' => 'home-settings',
         'label' => __( 'Portfolio section', 'clearsky' ),
         'description' => __( 'To use this section you must download and install our free <a href="https://wordpress.org/plugins/ig-portfolio/" target="_blank">IG Portfolio</a> plugin.', 'clearsky' ),
         'active_callback' => 'is_home',
    ) ) );
//home_portfolio
    ...
    $wp_customize->add_control('home_portfolio', array(
        'label' => __('Enable portfolio section?', 'clearsky'),
        'description' => __('', 'clearsky'),
        'type' => 'checkbox',
        'section' => 'home-settings',
...
//home_portfolio_title
    $wp_customize->add_setting('home_portfolio_title', array(
        'default' => __('Our new projects', 'clearsky'),
        'sanitize_callback' => 'igthemes_sanitize_textarea',
    ));
    $wp_customize->add_control('home_portfolio_title', array(
        'label' => __('', 'clearsky'),
        'description' => __('Section title', 'clearsky'),
        'type' => 'text',
        'section' => 'home-settings',
...
//home_portfolio_description
    $wp_customize->add_setting('home_portfolio_description', array(
        'sanitize_callback' => 'igthemes_sanitize_text',
        'default' => __('See our latest works!', 'clearsky'),
         'active_callback' => 'is_home',
    ));
    $wp_customize->add_control('home_portfolio_description', array(
        'label' => __('', 'clearsky'),
        'description' => __('Section description', 'clearsky'),
        'type' => 'textarea',
        'section' => 'home-settings',
...
//home_portfolio_tax
    ...
    $wp_customize->add_control('home_portfolio_tax', array(
        'label' => __('', 'clearsky'),
        'description' => __('Write the slug of the category you want to show', 'clearsky'),
        'type' => 'text',
        'section' => 'home-settings',
...
//home_testimonials_heading
    ...
    $wp_customize->add_control( new IGthemes_Heading( $wp_customize, 'home_testimonials_heading', array(
         'section' => 'home-settings',
         'label' => __( 'Testimonials section', 'clearsky' ),
         'description' => __( 'To use this section you must download and install our free <a href="https://wordpress.org/plugins/ig-testimonals/" target="_blank">IG Testimonials</a> plugin.', 'clearsky' ),
         'active_callback' => 'is_home',
    ) ) );
//home_testimonials
    ...
    $wp_customize->add_control('home_testimonials', array(
        'label' => __('Enable testimonials section?', 'clearsky'),
        'description' => __('', 'clearsky'),
        'type' => 'checkbox',
        'section' => 'home-settings',
...
//home_testimonials_title
    $wp_customize->add_setting('home_testimonials_title', array(
        'default' => __('What our clients says', 'clearsky'),
         'sanitize_callback' => 'igthemes_sanitize_textarea',
    ));
    $wp_customize->add_control('home_testimonials_title', array(
        'label' => esc_html__('', 'clearsky'),
        'description' => __('Section title', 'clearsky'),
        'type' => 'text',
        'section' => 'home-settings',
...
//home_testimonials_description
    $wp_customize->add_setting('home_testimonials_description', array(
        'sanitize_callback' => 'igthemes_sanitize_text',
        'default' => __('We make every thing with best quality, our customers and partners are very happy!', 'clearsky'),
    ));
...
//Images
    ...
    $wp_customize->add_control( new IGthemes_Heading( $wp_customize, 'blog-layout', array(
        'label' => esc_html__('Blog layout', 'clearsky'),
        'description' => esc_html__('', 'clearsky'),
...
//main layout
    ...
    $wp_customize->add_control(
            ...
            array(
                'label'			=> __( '', 'clearsky' ),
                'description'	=> __( 'Select the blog layout', 'clearsky' ),
                'priority' =>   2, 
                'type'          => 'radio-image',
                'section'		=> 'blog-settings',
...
//main post content
    ...
    $wp_customize->add_control('main_post_content', array(
        'label' => esc_html__('Display full posts content', 'clearsky'),
        'description' => esc_html__('', 'clearsky'),
        'type' => 'checkbox',
        'section' => 'blog-settings',
...
//Images
    ...
    $wp_customize->add_control( new IGthemes_Heading( $wp_customize, 'images', array(
        'label' => esc_html__('Images', 'clearsky'),
        'description' => esc_html__('', 'clearsky'),
        'section' => 'blog-settings',
        'settings' => 'images',
        'priority'   => 5,
...
//main featured images
    ...
    $wp_customize->add_control('main_featured_images', array(
        'label' => esc_html__('Display posts featured images', 'clearsky'),
        'description' => esc_html__('', 'clearsky'),
        'type' => 'checkbox',
        'section' => 'blog-settings',
...
//Navigation
    ...
    $wp_customize->add_control( new IGthemes_Heading( $wp_customize, 'navigation', array(
        'label' => esc_html__('Navigation', 'clearsky'),
        'description' => esc_html__('', 'clearsky'),
        'section' => 'blog-settings',
        'settings' => 'navigation',
    ) ) );
//numeric_pagination
    ...
    $wp_customize->add_control(
        'numeric_pagination',
        array(
            'label'         => esc_html__('Use numeric pagination?', 'clearsky'),
            'description'   => __( 'WP-PageNavi supported', 'clearsky'),
            'type'          => 'checkbox',
            'section'       => 'blog-settings',
...
******************************************************************/
    ...
    $wp_customize->add_control(
        'breadcrumb',
        array(
            'label'         => esc_html__('Display breadcrumb?', 'clearsky'),
            'description'   => __( 'Yoast Breadcrumb supported<br>NavXT Breadcrumb supported', 'clearsky'),
            'type'          => 'checkbox',
            'section'       => 'post-settings',
    ...
    $wp_customize->add_control( 'post_nav',
        array(
            'label'         => esc_html__('Show previous/next post links?', 'clearsky'),
            'description'   => __( '', 'clearsky'),
            'type'          => 'checkbox',
            'section'       => 'post-settings',
            'settings'      => 'post_nav',
...
//header colors
    ...
    $wp_customize->add_control( new IGthemes_Heading( $wp_customize, 'header_colors', array(
        'label' => esc_html__('Colors', 'clearsky'),
        'description' => esc_html__('', 'clearsky'),
...
//header color
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'header_background_color',
            array(
                'label' => __('', 'clearsky'),
                'description' => __('Background color', 'clearsky'),
                'type' => 'color',
                'section' => 'header-settings',
...
//header text color
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'header_text_color',
            array(
                'label' => __('', 'clearsky'),
                'description' => __('Text color', 'clearsky'),
                'type' => 'color',
                'section' => 'header-settings',
...
//header link normal
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'header_link_normal',
            array(
                'label' => __('', 'clearsky'),
                'description' => __('Link color', 'clearsky'),
                'type' => 'color',
                'section' => 'header-settings',
...
//header link hover
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'header_link_hover',
            array(
                'label' => __('', 'clearsky'),
                'description' => __('Link hover color', 'clearsky'),
                'type' => 'color',
                'section' => 'header-settings',
...
******************************************************************/
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'body_text_color',
            array(
                'label' => __('', 'clearsky'),
                'description' => __('Body text color', 'clearsky'),
                'priority' => 1,
                'type' => 'color',
                'section' => 'typography-settings',
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'body_headings_color',
            array(
                'label' => __('', 'clearsky'),
                'description' => __('Headings color', 'clearsky'),
                'priority' => 2,
                'type' => 'color',
                'section' => 'typography-settings',
...
******************************************************************/
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'button_background_hover',
            array(
                'label' => __('', 'clearsky'),
                'description' => __('Background hover', 'clearsky'),
                'priority' => 2,
                'type' => 'color',
                'section' => 'buttons-settings',
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'button_text_normal',
            array(
                'label' => __('', 'clearsky'),
                'description' => __('Text normal', 'clearsky'),
                'priority' => 3,
                'type' => 'color',
                'section' => 'buttons-settings',
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'button_text_hover',
            array(
                'label' => __('', 'clearsky'),
                'description' => __('Text hover', 'clearsky'),
                'priority' => 4,
                'type' => 'color',
                'section' => 'buttons-settings',
...
******************************************************************/
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'footer_headings_color',
            array(
                'label' => __('', 'clearsky'),
                'description' => __('Hedings color', 'clearsky'),
                'priority' => 3,
                'type' => 'color',
                'section' => 'footer-settings',
...
//facebook
    ...
    $wp_customize->add_control('facebook_url', array(
        'label' => esc_html__('Facebook url', 'clearsky'),
        'type' => 'url',
...
//twitter
    ...
    $wp_customize->add_control('twitter_url', array(
        'label' => esc_html__('Twitter url', 'clearsky'),
        'type' => 'url',
        'section' => 'social-settings',
...
//google
    ...
    $wp_customize->add_control('google_url', array(
        'label' => esc_html__('Google plus url', 'clearsky'),
        'type' => 'url',
        'section' => 'social-settings',
        'settings' => 'google_url',
    ));
//pinterest
    ...
    $wp_customize->add_control('pinterest_url', array(
        'label' => esc_html__('Pinterest url', 'clearsky'),
        'type' => 'url',
        'section' => 'social-settings',
...
//tumblr
    ...
    $wp_customize->add_control('tumblr_url', array(
        'label' => esc_html__('Tumblr url', 'clearsky'),
        'type' => 'url',
        'section' => 'social-settings',
        'settings' => 'tumblr_url',
    ));
//instagram
    ...
    $wp_customize->add_control('instagram_url', array(
        'label' => esc_html__('Instagram url', 'clearsky'),
        'type' => 'url',
        'section' => 'social-settings',
...
//linkedin
    ...
    $wp_customize->add_control('linkedin_url', array(
        'label' => esc_html__('Linkedin url', 'clearsky'),
        'type' => 'url',
        'section' => 'social-settings',
...
//dribbble
    ...
    $wp_customize->add_control('dribbble_url', array(
        'label' => esc_html__('Dribble url', 'clearsky'),
        'type' => 'url',
        'section' => 'social-settings',
...
//youtube
    ...
    $wp_customize->add_control('youtube_url', array(
        'label' => esc_html__('Youtube url', 'clearsky'),
        'type' => 'url',
        'section' => 'social-settings',

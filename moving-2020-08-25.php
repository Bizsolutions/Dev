...
//                    echo $skksksksavharraa-$skkskskspricearr;
//                    echo '<br>';
//                    echo ;
                    
                    
                    
                    //str_replace(',','+',$pricearr);
                    ...
                    <p class="review-para-1" style="font-size:18px !important;">
                        ...
                        //if($avgallregion > $local_avg_cost){
//                            $highre_lower   = 'Higher';
//                            $valeehk        = round((($avgallregion - $local_avg_cost) / $avgallregion) * 100, 1);
//                            
//                        }else{
//                            $highre_lower = 'cheaper';
//                            $valeehk        = round((($local_avg_cost  - $avgallregion  ) / $local_avg_cost) * 100, 1);
//                        }

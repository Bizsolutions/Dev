...
if (isset($_GET['id']))
    ...
    $company_id = 54;
$sql_company = "
        SELECT count(*),companies.title,companies.address,reviews.text,companies.id,companies.rating,companies.address,companies.phone,companies.website,companies.email,companies.logo,companies.city,companies.state,companies.zipcode  
            FROM  companies  , reviews    where companies.id=reviews.company_id and companies.id=$company_id";
...
if($res_company['count(*)']>3){ $rating_title=" With " . $res_company['count(*)'] . " Moving Reviews ";}
else { $rating_title="";}
...
<html lang="en">
    <head>
        <title><?php echo $res_company['title'] . "-" . $res_company['city'] . ", " . $res_company['state'] . $rating_title; ?></title>




        <link rel="icon" href="https://www.topmovingreviews.com/favicon.png" type="image/png" sizes="16x16"> 
        <meta name="description" content="<?php echo $res_company['title'] . " Reviews, ". $res_company['city'] . "," . $res_company['state']. ".". date("Y")." moving costs. Compare movers, get a free Moving quotes and pricing"; ?>">
        <meta name=keywords content="<?php echo $res_company['title']; ?>">
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />
        <meta name="HandheldFriendly" content="true">
        <meta property=og:title content="<?php echo $res_company['title'] . "-" . $res_company['city'] . ", " . $res_company['state'] . $rating_title; ?>">
        <meta property=og:description content="<?php echo $res_company['title'] . " Reviews, ". $res_company['city'] . "," . $res_company['state']. ".". date("Y")." moving costs. Compare movers, get a free Moving quotes and pricing"; ?>">
        ...
        <meta name="twitter:title" content="<?php echo $res_company['title'] . "-" . $res_company['city'] . ", " . $res_company['state'] . $rating_title; ?>" />
        <meta name="twitter:image" content="https://topmovingreviews.com/mmr_images/logos/logo_<?php echo $company_id; ?>.jpg"/>
        <meta name="twitter:description" content="<?php echo $res_company['title'] . " Reviews, ". $res_company['city'] . "," . $res_company['state']. ".". date("Y")." moving costs. Compare movers, get a free Moving quotes and pricing"; ?>" />
        <?php  $qrer        = " SELECT min(rating) as minRating , max(rating)  as bestRating FROM reviews where company_id=".$company_id; 
                $resultt    = mysql_query($qrer);
                $resultt    = mysql_fetch_array($resultt);
                $minRating  = $resultt['minRating'];
                $bestRating  = $resultt['bestRating'];
        ...
        <meta name="twitter:site" content="@topmovingreviews" />
            ...
            "@context": "https://schema.org/",
              ...
              "address": "<?php echo $res_company['address']. ' '.$res_company['city'].' '.$res_company['state'];?>",
...
?>
                    ...
                    <br>
                        ...
                        if(!empty($Region ) ){ 
                            ...
                            switch ($Region) {
                                case 'North East':
                                    if(!empty($SouthEast ) or strpos($SouthEast, '- ') !== false)echo  "Moving to the South East would be around $". $SouthEast.'<br>';
                                    if(!empty($West) or strpos($West , '- ') !== false)echo  "Moving to the West would be around $". $West.'<br>';
                                    if(!empty($Northwest) or strpos($Northwest , '- ') !== false )echo  "Moving to the North West would be around $". $Northwest.'<br>';
                                    if(!empty($NorthMedwest ) or strpos($NorthMedwest , '- ') !== false)echo  "Moving to the North Med West would be around $". $NorthMedwest.'<br>';
                                    if(!empty($SouthMedwest) or strpos($SouthMedwest , '- ') !== false)echo  "Moving to the South Med West would be around $". $SouthMedwest.'<br>';
                                    break;
                                case 'South East':
                                    if(!empty($NorthEast) or strpos($NorthEast, '- ') !== false)echo  "Moving to the North East would be around $". $NorthEast.'<br>';
                                    if(!empty($West) or strpos($West , '- ') !== false)echo  "Moving to the West would be around $". $West.'<br>';
                                    if(!empty($Northwest) or strpos($Northwest , '- ') !== false )echo  "Moving to the North West would be around $". $Northwest.'<br>';
                                    if(!empty($NorthMedwest ) or strpos($NorthMedwest , '- ') !== false)echo  "Moving to the North Med West would be around $". $NorthMedwest.'<br>';
                                    if(!empty($SouthMedwest) or strpos($SouthMedwest , '- ') !== false)echo  "Moving to the South Med West would be around $". $SouthMedwest.'<br>';
                                ...
                                case 'Med East':
                                    ...
                                    if(!empty($SouthEast ) or strpos($SouthEast, '- ') !== false)echo  "Moving to the South East would be around $". $SouthEast.'<br>';
                                    if(!empty($West) or strpos($West , '- ') !== false )echo  "Moving to the West would be around $". $West.'<br>';
                                    if(!empty($Northwest) or strpos($Northwest, '- ') !== false )echo  "Moving to the West would be around $". $Northwest.'<br>';
                                    if(!empty($SouthMedwest) or strpos($SouthMedwest , '- ') !== false)echo  "Moving to the Med West would be around $". $SouthMedwest.'<br>';
                                    break;

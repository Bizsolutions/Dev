            ...
            <div class="content">
                <div class="block-left">
                    <div class="bread-crumbs">
                        <span class="bread-name">
                            <a href="https://www.topmovingreviews.com/index.php">
                                Home
                            </a> 
                            <span class="arrow">></span> 
                            <a href="https://www.topmovingreviews.com/moving-company.php">
                                Movers 
                            </a>
                            <span class="arrow">></span>
                        </span>
                        <span class="current"> 
                            <a href="https://www.topmovingreviews.com/moving-companies/<?php echo ucfirst($cityname) . "-" . strtoupper($stateshrtname) . "-" . $zipcode; ?>/">
                                <?php echo ucwords($cityname); ?> Movers
                            </a>
                        </span>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 text-right">
                            <form  name="frm_filter" action='https://www.topmovingreviews.com/moving-companies/<?php echo $cityname . "-" . $stateshrtname . "-" . $zipcode; ?>/' method='post'>
                    ...
                    $cityQuery = "SELECT *  FROM    companies  , reviews    where companies.id=reviews.company_id and city in ('$cityname') group by companies.id";
                    $query = mysqli_query($link, $cityQuery);
                                        ...
                                        <div class='city-box' >
                                            ...
                                            if ($result = mysqli_query($link, $get_city)) {
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    ?>
                                                    <div class='city-box' >
                                                                                                                    <?php echo round($row['distance'], 0) . "<span style=font-size:11px>mi</span>" . "   " . "<a href=https://www.topmovingreviews.com/moving-companies/<?php echo str_replace(" ", "-", $row['city']) . "-" . $row['state_code'] . "-" . $row['zip']; ?>/>" .substr(str_replace("-", " ", $row['city']), 0, 13); ?>
                                                        </a>
                                                    </div>
                                                    <?php
                                                }

...
?>
                    ...
                    <p class="review-para-1" style="font-size:18px !important;">US D.O.T: <a href="<?php echo $res_dot['company_url']; ?>" target="_blank"><?php if ($res_dot['usdot_number'] == '') {
    echo "Not Updated";
} else {
    echo $res_dot['usdot_number'];
} ?></a><br>
                        (US Department of Transportation number)</p>
                    <p class="review-para-1" style="font-size:18px !important;">ICC MC number: <a href="<?php echo $res_dot['company_url']; ?>" target="_blank"><?php if ($res_dot['mc'] == '') {
    echo "Not Updated";
} else {
    echo "MC-" . $res_dot['mc'];
} ?></a><br>
                    ...
                    } ?> located in <?php echo $res_company['address']; ?>  <a rel="nofollow" href="https://www.topmovingreviews.com/map.php?query=<?php echo substr(str_replace(",", "%2C", str_replace(" ", "+", $res_company['address'])), 0, -4); ?>" target="_blank">View On Map</a>, but moving companies covered larger areas includes states nearby.
                    </p>

...
// 		}
                ...
                <div class="block-right">
                        ...
                        <div class="city">
                            ...
                            if ($result = mysqli_query($link, $get_state)) {
                                if (mysqli_num_rows($result) > 1) {
                                    ...
                                    echo "<span href='' style='color: #FF0000;'>" . "No Movers in your nearby States" . "</span>";
                                }
                            }
                            /* } else {
                    ...
                    <div class="cities">
                        ...
                        <div class="city">
                            <?php
                            //select distinct(SUBSTRING_INDEX(SUBSTRING_INDEX(address,\",\",-3),\",\",1)) as city ,id from companies where address like '% $stateshrtname %'
...
//address like '% $res_city[city]%' and address like '% $stateshrtname %'
                                ...
                                <div class="city-box">
                                    <a href="<?= $connection->baseUrl()?>moving-companies/<?php echo str_replace(" ", "-", ltrim($res_city['city'])) . "-" . $stateshrtname . "-" . $res_city['zips']; ?>/">									<?php echo $res_city['city']; ?></a>
                                </div>

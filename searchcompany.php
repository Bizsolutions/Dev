...
<table width="100%" border="0" cellspacing="4	">
  ...
  <tr>
    ...
    <td><input  name="company_search" type="text" class="form-control" value="<?php echo $_REQUEST['company_search'];?>">
...
{	
	...
	if ($page > 1) 
		...
		$pagination.= "<li class=\"page-item\"><a href=\"$targetpage?page=$prev&company_search=$_REQUEST[company_search]\" class=\"page-link\">Previous</a></li>";
	...
	if ($page < $counter - 1) 
		...
		$pagination.= "<li><a href=\"$targetpage?page=$next&company_search=$_REQUEST[company_search]\">Next</a></li>";

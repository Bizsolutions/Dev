...
$res_zip=mysqli_fetch_array(mysqli_query($link,$sql_zip));
...
$sql=mysqli_query($link,"SELECT city,state FROM zipcodes where zipcode = '$FromZip'"); 
...
$sql2=mysqli_query($link,"SELECT city,county,state,zipcode FROM zipcodes where zipcode = '$ToZip'"); 

...
<form name="frm_search" action="searchcompanybadge.php" method="post">
 ...
 <div style="width:500px; height:335px; background:#E1E1E1 border-radius:5px; vertical-align:middle; padding:20px; margin-left:400px;">
...
<p class="text-center" style="color:#FF0000;">Do you want to have this badge in your website?</p>
...
<br/><br/>
<table width="100" border="0" cellspacing="4"  id="a" style="visibility:hidden; margin-left:400px; margin-top:50px"  >
  <tr>
    <td>Use the search box below to look up your moving company badge.<br><input  name="company_search" type="text" style=" background-color:#FFFFFF;width:500px; border:0px solid #000000;border-radius: 3px; height:46px;box-shadow: 0 2px 2px 0 rgba(0,0,0,0.16), 0 0 0 1px rgba(0,0,0,0.08);font-size: 18px; color:#777;" value="<?php echo $_REQUEST['company_search'];?>">
</td>

...
<img src="https://www.topmovingreviews.com/images/logo.jpg" alt="top moving logo">
...
<form name="search" action="https://www.topmovingreviews.com/searchcompany.php" method="post"><div class="search-box"> <input type="text" id="search" name="company_search" value="Looking For" onfocus="this.value=''" > <button><i class="fa fa-search"></i>&nbsp;Search</button></div></form>
</div>
</div>
...
<div class="header-banner-withoutform"><div class="banner-right"><h2 class="banner-titile-2">Plan Your Perfect Move</h2></div></div>

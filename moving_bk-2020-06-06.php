...
<label><input class=newinput  value="From Zip" onFocus="this.value=''" name="MovingFrom" id="MovingFrom" ></label>



<label><input class=newinput  value="To Zip or City, State" onFocus="this.value=''" name="MovingTo" id="MovingTo"></label>



<div class=submit-new><a class= onClick="javascript:return validate()" style="cursor:pointer;">Continue</a> </div>

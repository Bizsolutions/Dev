...
?>
                    ...
                    <p class="review-para-1" style="font-size:18px !important;">
                        ...
                        <?php  
                            ...
                            //strpos($Northeast, '- ') !== false
                        ?>
                        <br>
                        <?php if(!empty($Northeast ) or strpos($Northeast, '- ') !== false)echo  "Moving to the North East would be around $". $Northeast.'<br>'?>
                        <?php if(!empty($Northwest) or strpos($Northwest , '- ') !== false )echo  "Moving to the North West would be around $". $Northwest.'<br>'?>
                        <?php if(!empty($NorthMedwest ) or strpos($NorthMedwest , '- ') !== false)echo  "Moving to the North Med West would be around $". $NorthMedwest.'<br>'?>
                        <?php if(!empty($SouthMedwest) or strpos($SouthMedwest , '- ') !== false)echo  "Moving to the South Med West would be around $". $SouthMedwest.'<br>'?>
                        <?php if(!empty($West) or strpos($West , '- ') !== false)echo  "Moving to the West would be around $". $West.'<br>'?>
                        ...
                        <br>
                        Please take note that the prices provided based on data such as reviews and other sources. The estimated amount that you receive from the company is lower. Several factors, like shipment size, the distance between locations, and other services like Packing and assembly, will contribute to the price of the move. We recommend you to save on packing and packing labor by purchasing packing supplies here.
                        <br>
                        And compare the moving costs from licensed movers here. 
                    </p>
